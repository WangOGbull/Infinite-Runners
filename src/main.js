...
import UIManager from './uiManager.js?v=67';
...
class Game {
  ...
  endGame(hasWinner = false) {
    ...
    // Multiplayer result-screen preparation: stop every gameplay input and
    // remove overlays before the Main Menu button becomes available.
