class UIManager {
  ...
  createDynamicModals() {
    ...
    if (!document.getElementById('arenaSelectModal')) {
      ...
      arenaModal.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;display:none;flex-direction:column;align-items:center;justify-content:center;background:rgba(7,16,24,0.95);z-index:100;color:#fff;overflow-y:auto;padding:16px;box-sizing:border-box;';
      arenaModal.innerHTML = `
        <div style="display:flex;flex-direction:column;align-items:center;gap:16px;max-width:500px;width:100%;padding:16px 0;">
          <h2 style="margin:0;font-size:clamp(18px,5vw,24px);text-transform:uppercase;letter-spacing:3px;text-shadow:0 0 20px rgba(0,180,216,0.5);text-align:center;">Select Arena</h2>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;width:100%;">
            <button class="arenaCard" data-arena="0" style="background:rgba(255,255,255,0.05);border:1px solid rgba(0,180,216,0.3);border-radius:10px;padding:8px;cursor:pointer;transition:all 0.2s;color:#fff;display:flex;flex-direction:column;align-items:center;gap:6px;" onmouseover="this.style.borderColor='rgba(0,180,216,0.8)';this.style.background='rgba(0,180,216,0.1)';" onmouseout="this.style.borderColor='rgba(0,180,216,0.3)';this.style.background='rgba(255,255,255,0.05)';">
              <div style="width:100%;aspect-ratio:1;background:#8B9DC3;border-radius:6px;background-image:url(https://raw.githubusercontent.com/WangOGbull/Infinite-Runners/main/arenas/arena_stone.png);background-size:cover;background-position:center;"></div>
              <div style="font-weight:600;font-size:clamp(10px,3vw,13px);">Stone Castle</div>
            </button>
            <button class="arenaCard" data-arena="1" style="background:rgba(255,255,255,0.05);border:1px solid rgba(0,180,216,0.3);border-radius:10px;padding:8px;cursor:pointer;transition:all 0.2s;color:#fff;display:flex;flex-direction:column;align-items:center;gap:6px;" onmouseover="this.style.borderColor='rgba(0,180,216,0.8)';this.style.background='rgba(0,180,216,0.1)';" onmouseout="this.style.borderColor='rgba(0,180,216,0.3)';this.style.background='rgba(255,255,255,0.05)';">
              <div style="width:100%;aspect-ratio:1;background:#4CAF50;border-radius:6px;background-image:url(https://raw.githubusercontent.com/WangOGbull/Infinite-Runners/main/arenas/arena_grass.png);background-size:cover;background-position:center;"></div>
              <div style="font-weight:600;font-size:clamp(10px,3vw,13px);">Grass Field</div>
            </button>
            <button class="arenaCard" data-arena="2" style="background:rgba(255,255,255,0.05);border:1px solid rgba(0,180,216,0.3);border-radius:10px;padding:8px;cursor:pointer;transition:all 0.2s;color:#fff;display:flex;flex-direction:column;align-items:center;gap:6px;" onmouseover="this.style.borderColor='rgba(0,180,216,0.8)';this.style.background='rgba(0,180,216,0.1)';" onmouseout="this.style.borderColor='rgba(0,180,216,0.3)';this.style.background='rgba(255,255,255,0.05)';">
              <div style="width:100%;aspect-ratio:1;background:#9C27B0;border-radius:6px;background-image:url(https://raw.githubusercontent.com/WangOGbull/Infinite-Runners/main/arenas/arena_purple.png);background-size:cover;background-position:center;"></div>
              <div style="font-weight:600;font-size:clamp(10px,3vw,13px);">Purple Magic</div>
            </button>
            <button class="arenaCard" data-arena="3" style="background:rgba(255,255,255,0.05);border:1px solid rgba(0,180,216,0.3);border-radius:10px;padding:8px;cursor:pointer;transition:all 0.2s;color:#fff;display:flex;flex-direction:column;align-items:center;gap:6px;" onmouseover="this.style.borderColor='rgba(0,180,216,0.8)';this.style.background='rgba(0,180,216,0.1)';" onmouseout="this.style.borderColor='rgba(0,180,216,0.3)';this.style.background='rgba(255,255,255,0.05)';">
              <div style="width:100%;aspect-ratio:1;background:#FF5722;border-radius:6px;background-image:url(https://raw.githubusercontent.com/WangOGbull/Infinite-Runners/main/arenas/arena_fire.png);background-size:cover;background-position:center;"></div>
              <div style="font-weight:600;font-size:clamp(10px,3vw,13px);">Fire Arena</div>
            </button>
          </div>
          <button id="btnArenaBack" style="background:transparent;border:1px solid rgba(0,180,216,0.4);color:#00b4d8;padding:10px 28px;border-radius:8px;cursor:pointer;font-size:clamp(11px,3vw,13px);text-transform:uppercase;letter-spacing:2px;transition:all 0.2s;" onmouseover="this.style.background='rgba(0,180,216,0.1)';this.style.borderColor='rgba(0,180,216,0.8)';" onmouseout="this.style.background='transparent';this.style.borderColor='rgba(0,180,216,0.4)';"><i data-lucide="arrow-left"></i> Back</button>
        </div>
      `;
